...
# TODO: You will have to rename this if you rename your CPSC217W23A3Board file (note you cannot use hyphens in your filename)
from CPSC217W23A3Board import *
...
def test_arguments():
    failures = [["CPSC217W23A3.py"],
                ["CPSC217W23A3.py", "3"],
                ["CPSC217W23A3.py", "3", "3"],
                ["CPSC217W23A3.py", "3", "3", "0"],
                ["CPSC217W23A3.py", "4", "4", "0", "X", "anything"],
                ["CPSC217W23A3.py", "3", "3", "0", "X", "-a", "anything"],
                ["CPSC217W23A3.py", "3", "3", "0", "X", "-h", "anything"],
                ["CPSC217W23A3.py", "2", "3", "0", "X"],
                ["CPSC217W23A3.py", "6", "3", "0", "X"],
                ["CPSC217W23A3.py", "3", "2", "0", "X"],
                ["CPSC217W23A3.py", "3", "6", "0", "X"],
                ["CPSC217W23A3.py", "3", "3", "5", "X"],
                ["CPSC217W23A3.py", "4", "4", "4", "X"],
                ["CPSC217W23A3.py", "3", "3", "4", "Z"],
                ["CPSC217W23A3.py", "a", "3", "0", "X"],
                ["CPSC217W23A3.py", "3", "a", "0", "X"],
                ["CPSC217W23A3.py", "3", "3", "a", "X"]]
    ...
    successes = [["CPSC217W23A3.py", "3", "3", "0", "X"],
                 ["CPSC217W23A3.py", "4", "3", "0", "X"],
                 ["CPSC217W23A3.py", "3", "4", "0", "X"],
                 ["CPSC217W23A3.py", "4", "4", "0", "X"],
                 ["CPSC217W23A3.py", "3", "3", "1", "X"],
                 ["CPSC217W23A3.py", "3", "3", "2", "X"],
                 ["CPSC217W23A3.py", "3", "3", "3", "X"],
                 ["CPSC217W23A3.py", "3", "3", "4", "X"],
                 ["CPSC217W23A3.py", "3", "4", "1", "X"],
                 ["CPSC217W23A3.py", "3", "4", "2", "X"],
                 ["CPSC217W23A3.py", "3", "4", "3", "X"],
                 ["CPSC217W23A3.py", "4", "3", "1", "X"],
                 ["CPSC217W23A3.py", "4", "3", "2", "X"],
                 ["CPSC217W23A3.py", "4", "3", "3", "X"],
                 ["CPSC217W23A3.py", "4", "4", "1", "X"],
                 ["CPSC217W23A3.py", "4", "4", "2", "X"],
                 ["CPSC217W23A3.py", "4", "4", "3", "X"],
                 ["CPSC217W23A3.py", "3", "3", "0", "O"],
                 ["CPSC217W23A3.py", "3", "3", "0", "X", "-h"],
                 ["CPSC217W23A3.py", "3", "3", "0", "X", "-a"],
                 ["CPSC217W23A3.py", "3", "5", "0", "X"],
                 ["CPSC217W23A3.py", "5", "3", "0", "X"],
                 ["CPSC217W23A3.py", "4", "5", "0", "X"],
                 ["CPSC217W23A3.py", "5", "4", "0", "X"],
                 ["CPSC217W23A3.py", "5", "5", "0", "X"]]
...
def check_arguments(args):
    if len(args) != 5 and len(args) != 6:
        ...
        print(
            "Usage: python CPSC217W23A3.py <rows> <cols> <difficulty> <piece> <optional -h hint -a advanced hint>")
        return False
